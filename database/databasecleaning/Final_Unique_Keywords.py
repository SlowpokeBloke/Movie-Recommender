...
# Write the result to a new CSV file containing unique keywords and their IDs
unique_keywords = expanded_keywords_df[['keyword_id', 'keyword_name']].drop_duplicates()
unique_keywords.to_csv('unique_keywords.csv', index=False)
